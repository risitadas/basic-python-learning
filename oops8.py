...
'''
What is Abstraction?
Abstraction refers to hiding unnecessary details to focus on the whole product
 ...
 It is a mechanism that represents the important features without including implementation details.
  Abstraction helps us in partitioning the program into many independent concepts so we may 
  hide the irrelevant information in the code. It offers the greatest flexibility when
   using abstract data-type objects in different situations.
...
Encapsulation means hiding under layers.
 When working with classes and handling sensitive data,
